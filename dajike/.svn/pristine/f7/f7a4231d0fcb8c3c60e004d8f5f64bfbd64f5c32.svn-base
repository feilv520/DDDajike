...
- (void)setupToolbars
{
    ...
    saveButton.frame = CGRectMake(WIDTH_CONTROLLER_DEFAULT-70, self.bounds.size.height - 70, 50, 25);
    ...
    UILabel *imgNameLabel = (UILabel *)[self viewWithTag:9999];
    if (!imgNameLabel) {
        imgNameLabel = [[UILabel alloc]init];
        imgNameLabel.tag = 9999;
        
        [self addSubview:imgNameLabel];
    }
    imgNameLabel.frame = CGRectMake(10, self.bounds.size.height-70, CGRectGetMinX(saveButton.frame)-20, 25);
    imgNameLabel.backgroundColor = [UIColor clearColor];
    imgNameLabel.textColor = [UIColor whiteColor];
    
    _imgNameLb = imgNameLabel;
...
- (NSURL *)highQualityImageURLForIndex:(NSInteger)index
{
    ...
    PhotoAlbumModel *model = [self.imgArr objectAtIndex:index];
    _imgNameLb.text = model.image_name;
