...
- (void)viewInit
{
    ...
    _navTabBar = [[SCNavTabBar alloc] initWithFrame:CGRectMake(DOT_COORDINATE, 64.0f, SCREEN_WIDTH, NAV_TAB_BAR_HEIGHT) showArrowButton:NO];
...
//    _mainView = [[UIScrollView alloc] initWithFrame:CGRectMake(DOT_COORDINATE, _navTabBar.frame.origin.y + _navTabBar.frame.size.height, SCREEN_WIDTH,30)];
...
//        UIViewController *viewController = (UIViewController *)_subViewControllers[i];
//        viewController.view.frame = CGRectMake(i * SCREEN_WIDTH, DOT_COORDINATE, SCREEN_WIDTH, _mainView.frame.size.height);
...
//        }
//        if (itHasAdd) {
//            viewController.view.frame = CGRectMake(_currentIndex * SCREEN_WIDTH, DOT_COORDINATE, SCREEN_WIDTH, _mainView.frame.size.height);
//            [_mainView addSubview:viewController.view];
//            [self addChildViewController:viewController];
//        }
//    }
