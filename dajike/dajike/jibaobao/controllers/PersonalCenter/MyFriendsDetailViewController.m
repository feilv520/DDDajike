...
@interface MyFriendsDetailViewController (){
    UILabel *_nameLab;
    UILabel *_contentLab;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!cell) {
        ...
        _nameLab = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH_CONTROLLER_DEFAULT/4 -60, 0, 120, 45.0)];
        _contentLab = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH_CONTROLLER_DEFAULT*3/4-60, 0, 120, 45.0)];
        
        _nameLab.textAlignment = NSTextAlignmentLeft;
        _nameLab.textColor = Color_word_bg;
        _contentLab.textAlignment = NSTextAlignmentLeft;
        _contentLab.textColor = Color_word_bg;
