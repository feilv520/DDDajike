...
@interface DSendOutHongBaoViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation DSendOutHongBaoViewController
...
- (void)viewDidLoad {
    ...
    [self.dMainTableView registerNib:[UINib nibWithNibName:@"HongBaoDetailCell" bundle:nil] forCellReuseIdentifier:swbCell];
...
- (void)setTabviewHeaderAndFooterView
{
    ...
    UIView *headerViewBG = [self.view createViewWithFrame:CGRectMake(0, 0, DWIDTH_CONTROLLER_DEFAULT, 80) andBackgroundColor:DColor_Clear];
    ...
    _lb1 = [self.view creatLabelWithFrame:CGRectMake(CGRectGetMaxX(headImg.frame)+5, 8, 150, 30) AndFont:15.0f AndBackgroundColor:DColor_Clear AndText:[NSString stringWithFormat:@"%@的红包",self.userInfoModel.nickName] AndTextAlignment:NSTextAlignmentLeft AndTextColor:DColor_word_bg andCornerRadius:0.0f];
    [headerViewBG addSubview:_lb1];
    NSLog(@"%@",self.userInfoModel.userName);
    UILabel *lb2 = [self.view creatLabelWithFrame:CGRectMake(CGRectGetMaxX(headImg.frame)+5, CGRectGetMaxY(_lb1.frame)+4, 150, 30) AndFont:15.0f AndBackgroundColor:DColor_Clear AndText:@"恭喜发财，心想事成" AndTextAlignment:NSTextAlignmentLeft AndTextColor:DColor_word_bg andCornerRadius:0.0f];
    [headerViewBG addSubview:lb2];
    
    UIView *lineV = [self.view createViewWithFrame:CGRectMake(0, headerViewBG.frame.size.height-1, DWIDTH_CONTROLLER_DEFAULT, 1) andBackgroundColor:DColor_line_bg];
    [headerViewBG addSubview:lineV];
    
    self.dMainTableView.tableHeaderView = headerViewBG;
    //设置尾视图
    UIView *footerVierBG = [self.view createViewWithFrame:CGRectMake(0, 0, DWIDTH_CONTROLLER_DEFAULT, 100) andBackgroundColor:DColor_Clear];
    UILabel *lb3 = [self.view creatLabelWithFrame:CGRectMake(10, 50, DWIDTH_CONTROLLER_DEFAULT-20, 30) AndFont:13.0f AndBackgroundColor:DColor_Clear AndText:@"红包编号：38726872334238768" AndTextAlignment:NSTextAlignmentCenter AndTextColor:DColor_word_bg andCornerRadius:0.0f];
    [footerVierBG addSubview:lb3];
    
    self.dMainTableView.tableFooterView = footerVierBG;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        lb.frame = CGRectMake(10, 5, DWIDTH_CONTROLLER_DEFAULT-20, 50);
        lb.numberOfLines = 0;
        lb.tag = 11;
