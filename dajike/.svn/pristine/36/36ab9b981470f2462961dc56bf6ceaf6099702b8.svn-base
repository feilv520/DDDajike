...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    _nameLab = [[UILabel alloc]initWithFrame:CGRectMake(DWIDTH_CONTROLLER_DEFAULT/4 -75, 0, 150, 33.0)];
    ...
    if (indexPath.row == 0) {
        ...
        [DTools setLable:_nameLab Font:DFont_14 titleColor:DColor_808080 backColor:[UIColor clearColor]];
        [DTools setLable:_shopNoLab Font:DFont_14 titleColor:DColor_808080 backColor:[UIColor clearColor]];
    }else{
        if (indexPath.row -1 < _friendsListArray.count) {
            ...
            [DTools setLable:_nameLab Font:DFont_12 titleColor:DColor_808080 backColor:[UIColor clearColor]];
            [DTools setLable:_shopNoLab Font:DFont_12 titleColor:DColor_808080 backColor:[UIColor clearColor]];
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row != 0) {
        ...
        friendDetailVC.myFriendsModel = _friendsListArray[indexPath.row+1];
