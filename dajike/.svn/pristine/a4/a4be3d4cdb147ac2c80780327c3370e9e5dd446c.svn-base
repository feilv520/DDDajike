...
-(void)setCellText:(NSString *)text align:(NSString*)align{
    ...
    if(_cellAccessoryView){
        ...
        //_cellAccessoryView.frame = CGRectMake(self.frame.size.width-26, (self.frame.size.height-12)/2, 16, 12);
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //    cell.backgroundView.backgroundColor = BackColor;
    ...
    if ([self.dataSource menu:self ifHasImageForRowAtIndexPath:[JSIndexPath indexPathWithCol:self.currentSelectedMenudIndex leftOrRight:leftOrRight leftRow:_leftSelectedRow row:indexPath.row]]) {
        [imageView setHidden:NO];
        imageView.image = [self.dataSource menu:self imageForRowAtIndexPath:[JSIndexPath indexPathWithCol:self.currentSelectedMenudIndex leftOrRight:leftOrRight leftRow:_leftSelectedRow row:indexPath.row]];
    ...
    if (leftOrRight == 1) {
        ...
        if([self.dataSource menu:self ifHasImageForRowAtIndexPath:[JSIndexPath indexPathWithCol:self.currentSelectedMenudIndex leftOrRight:leftOrRight leftRow:_leftSelectedRow row:indexPath.row]]) {
            imageView.frame = CGRectMake(marginX-10, 12, 20, 20);
            titleLabel.frame = CGRectMake(marginX+10, 0, textSize.width, cell.frame.size.height);
        }else{
        ...
        if ([titleLabel.text isEqualToString:[(CATextLayer *)[_titles objectAtIndex:_currentSelectedMenudIndex] string]]) {
            ...
            accessoryImageView.frame = CGRectMake(tableView.frame.size.width-26, (self.frame.size.height-12)/2, 16, 12);
...
//        
//        if([self.dataSource menu:self ifHasImageForRowAtIndexPath:[JSIndexPath indexPathWithCol:self.currentSelectedMenudIndex leftOrRight:leftOrRight leftRow:_leftSelectedRow row:indexPath.row]]) {
//            imageView.frame = CGRectMake(marginX-10, 5, 20, 20);
//            titleLabel.frame = CGRectMake(marginX+10, 0, textSize.width, cell.frame.size.height);
//        }else{
//            titleLabel.frame = CGRectMake(marginX, 0, textSize.width, cell.frame.size.height);
//        }
...
//         BOOL haveRightTableView = [_dataSource haveRightTableViewInColumn:_currentSelectedMenudIndex];
//        if ((isDefault == YES)&&(indexPath.row == 0)&&(haveRightTableView == YES)) {
//            cell.backgroundColor = [UIColor whiteColor];
//        }
