...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([FileOperation isLogin]) {
        ...
        [FileOperation setPlistObject:[NSString stringWithFormat:@"%d",[DGouWuCheOperation getGouWuCheNum]] forKey:@"cartCount" ofFilePath:[FileOperation creatPlistIfNotExist:jibaobaoUser]];
    }
...
//    NSLog(@"vvvv =%@",[[NSString stringWithFormat:@"%@",url] substringToIndex:24]);
    ...
    if ([sourceApplication isEqualToString:@"com.tencent.xin"]) {
        if ([NSString stringWithFormat:@"%@",url].length > 24) {
