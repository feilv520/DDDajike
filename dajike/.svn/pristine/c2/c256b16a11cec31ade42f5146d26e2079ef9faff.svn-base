...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == self.dMainTableView) {
        ...
        cell.detailLabel.text = [detailArray objectAtIndex:indexPath.row];
        ...
        cell.classLabel.text = [[[[[self.oneArray objectAtIndex:self.oneIndexPath.row] objectForKey:@"twoArray"] objectAtIndex:indexPath.row] objectForKey:@"twoName"]cate_name];
    ...
    [[DMyAfHTTPClient sharedClient]postPathWithMethod:@"Goods.goodsCategory" parameters:nil ifAddActivityIndicator:NO success:^(AFHTTPRequestOperation *operation, PostData *responseObject) {
        if (responseObject.succeed) {
            ...
            for (NSDictionary *dic in dataArr) {
                ...
                [detailArray addObject:self.detailString];
            }
