...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.tableViewIndex = [[BATableViewIndex alloc] initWithFrame:(CGRect){300-10,-20,20+10,frame.size.height}];
...
//    rect.size.height = self.tableViewIndex.indexes.count * 16;
    rect.size.height = self.frame.size.height;
    rect.origin.y = (self.bounds.size.height - rect.size.height - edgeInsets.top - edgeInsets.bottom) / 2 + edgeInsets.top + 20-20;
//    rect.size.height = self.frame.size.height;
//    rect.origin.y = 0;
    self.tableViewIndex.frame = rect;
    self.tableViewIndex.tableViewIndexDelegate = self;
